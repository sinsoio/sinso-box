...
class ColorUtil {
  ...
  static Color setColor(String colorString, {double alpha = 1.0}) {
  ...
  ///默认主题颜色
  static Color setDefaultColor() {
    return setColor("#44B5F5");
  }

  ///默认字体颜色
  static Color setDefaultTextColor() {
    return setColor("#333333");
  }

  ///背景颜色
  static Color setBackgroundColor() {
    return setColor("#F4F6FC");
  }
}
